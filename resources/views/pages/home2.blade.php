...
<style>
    ...
    .bg-color::before {
        ...
        opacity: 0.8;
        box-shadow: 0 0 10px #de9638;
        transition: all 0.3s ease;
        pointer-events: none;
        animation: pulseGlow 2s infinite alternate;
    }

    /* Trigger animation only when image is hovered */
    ...
    @keyframes pulseGlow {
        ...
        /* 50% {
            opacity: 1;
            box-shadow: 0 0 20px #de9638, 0 0 30px #de9638;
        } */
        ...
        <div class="row">
            <div class="col-xl-6">
                <div class="buy-ticket__left" data-aos="fade-right" data-aos-duration="1000">
                    ...
                    <h3 class="buy-ticket__title mt-0">About Kings</h3>
                    <p class="buy-ticket__text stagger-line">At The Kings, we don’t just dance; we elevate it to an art form. From
                    ...
                    <p class="buy-ticket__text stagger-line">
            ...
            <div class="col-xl-6">
                <div class="buy-ticket__right" data-aos="fade-left" data-aos-duration="1000">
                    <div class="buy-ticket__img bg-color">
